...
test("Make Offer XCH -> BSH", async () => {
  ...
  const offs: OfferEntity[] = getOfferEntities([{ token: xchSymbol(), amount: "0.1" }], "()", catIds(), xchSymbol());
...
test("Make Offer BSH -> XCH", async () => {
  ...
  const offs: OfferEntity[] = getOfferEntities([{ token: "BSH", amount: "5" }], "()", catIds(), xchSymbol());
        ...
        targets: [
          {
            ...
            amount: 10n,
            symbol: "BSH",
            memos: ["0xbae24162efbd568f89bc7a340798a6118df0189eb9e3f8697bcea27af99f8f79"],
          },
          {
            symbol: "BSH",
            address: "0x907ecc36e25ede9466dc1db20f86d8678b4a518a4351b552fb19be20fc6aac96",

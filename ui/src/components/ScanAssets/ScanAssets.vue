...
<script lang="ts">
import { AccountEntity, AccountTokens, CustomCat, OneTokenInfo, TokenInfo } from "../../../../lib-chia/models/account";
import { getCatIdDict, getCatNames, getTokenInfo } from "@/services/view/cat";
import { Component, Prop, Vue, Watch } from "vue-property-decorator";
import receive, { DidDetail, NftDetail, TokenPuzzleObserver } from "../../../../lib-chia/services/crypto/receive";
import { ensureAddress, rpcUrl, xchPrefix, xchSymbol } from "@/store/modules/network";
import { CoinRecord, GetRecordsResponse } from "../../../../lib-chia/models/wallet";
import debug from "../../../../lib-chia/services/api/debug";
import { analyzeNftCoin, getScalarString } from "../../../../lib-chia/services/coin/nft";
import puzzle, { PuzzleObserver } from "../../../../lib-chia/services/crypto/puzzle";
import { analyzeCatCoin, CatCoinAnalysisResult } from "../../../../lib-chia/services/coin/cat";
...
import { analyzeDidCoin, DidCoinAnalysisResult } from "../../../../lib-chia/services/coin/did";
import KeyBox from "../Common/KeyBox.vue";
import SignMessage from "../Cryptography/SignMessage.vue";
import { convertToOriginCoin } from "../../../../lib-chia/services/coin/coinUtility";

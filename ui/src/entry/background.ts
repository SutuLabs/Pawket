...
export interface RequestType {
  command: "store" | "retrieve" | "remove" | "getAddress";
  key?: string;
  value?: string;
}
...
chrome.runtime.onMessage.addListener(function (request: RequestType, sender, sendResponse: (response?: ResponseType) => void) {
  if (sender.tab) {

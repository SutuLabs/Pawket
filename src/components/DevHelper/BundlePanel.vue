<template>
  <div>
    <b-field>
      <template #label>
        Bundle
        <key-box :showValue="false" icon="checkbox-multiple-blank-outline" :value="bundleText" tooltip="Copy"></key-box>
      </template>
    ...
    <template v-if="bundle">
      ...
      <b-field>
        <template #label>
          Puzzle
          <key-box :showValue="false" icon="checkbox-multiple-blank-outline" :value="puzzle" tooltip="Copy"></key-box>
      ...
      <b-field v-if="uncurried_module">
        <template #label>
          Uncurried Result
          <key-box :showValue="false" icon="checkbox-multiple-blank-outline" :value="uncurried_module" tooltip="Copy"></key-box>
      ...
      <b-field>
        <template #label>
          Solution
          <key-box :showValue="false" icon="checkbox-multiple-blank-outline" :value="solution" tooltip="Copy"></key-box>
          <b-button
            v-if="
      ...
      <b-field v-if="solution_result">
        <template #label>
          Solution Result
          <key-box :showValue="false" icon="checkbox-multiple-blank-outline" :value="solution_result" tooltip="Copy"></key-box>

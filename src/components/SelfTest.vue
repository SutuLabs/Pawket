...
export default class SelfTest extends Vue {
  ...
  async testCatTransfer2(): Promise<void> {
    ...
    const sk_hex = "40fbb0dad159776ed05afbaeac4f4fe1b975e93bf5e9dda9fbf4e375346d12a0";
    const tgt_addr = await puzzle.getAddressFromPuzzleHash("0x1cf63b7cc60279a1b0745e8f426585ee81d8da0cd2d92dd9b44e6efbd88d40ce", "xch");
    const change_addr = await puzzle.getAddressFromPuzzleHash("0xc467280169dfc93e7a14b98475641996966d4d3800f814a2baaeab14a96e3b40", "xch");

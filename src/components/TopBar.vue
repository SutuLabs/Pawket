<template>
  <div class="is-size-5 pt-5 pb-2 pr-2 border-bottom modal-card-body">
    ...
    <div class="is-hidden-mobile has-text-left">
      <span @click="$emit('close')"><b-icon class="is-pulled-left has-text-grey pt-2" icon="chevron-left"> </b-icon></span>
      <span>{{ title }}</span>
    </div>
  </div>
</template>

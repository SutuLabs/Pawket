...
import { importModsHex, importModsProg } from "./imports";
import { otherModsHex, otherModsProg } from "./otherMods";
...
export const modsdict: { [mod: string]: string } = mods.reduce((acc, cur) => ({ ...acc, [allModsProg[cur.name]]: cur.name }), {});

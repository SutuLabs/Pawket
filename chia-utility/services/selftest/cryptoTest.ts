...
export async function testCryptography(): Promise<void> {
  ...
  assert("89d4ca795881dc192cf7e0bcf22528c3d7708f57aa644647ae2506cd10405dc528b36e450ab901675f7a6289a4335a22", masterpubkey);
  assert("2308828858", sk.publicKey().get_fingerprint().toString());
  ...
  assert("99f181b1b30865339eea4e61172e64282ed1793022363f6635affbfb2aa2f4384ef10df47a445f92d685c7265488777e", farmerpubkey);
  ...
  assert("8b58921998b2337fd9d4a410e8bd11dfda435feb92dc3d6f3e111194b99a0391f39cf9b9534a44d154c9d7492400f36b", walletpubkey);
  // });

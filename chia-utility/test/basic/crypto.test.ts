...
test("Sign Message By XCH", async () => {
  ...
  if (!sk) assert.fail("cannot find sk");
...
test("Sign Message By DID", async () => {
  ...
  if (!analysis) assert.fail("cannot parse did coin");
...
test("Sign Message By NFT", async () => {
  ...
  if (!analysis) assert.fail("cannot parse nft coin");
  ...
  return Promise.resolve(<never>{
    ...
    json: async () => {
      if (
        url == "Wallet/records" &&
        args.body ==
          '{"puzzleHashes":["0x83baea4313afa1a5b174d1afef81ac640688a3a0157c418536c06e2b556adc55"],"includeSpentCoins":true,"hint":false}'
      )
        return {
          coins: [
            {
      ...
      if (
        url == "Wallet/records" &&
        args.body ==
          '{"puzzleHashes":["0x7ed1a136bdb4016e62922e690b897e85ee1970f1caf63c1cbe27e4e32f776d10"],"includeSpentCoins":true,"hint":false}'
      )
        return {
          coins: [
            {
      ...
      if (
        url == "Wallet/get-puzzle" &&
        args.body == '{"parentCoinId":"0xc20ab64698a0fc4dc1583b984c97eecb9f9348fb3343bfc5f5c94ee50bc05956"}'
      )
        return {
          ...
          puzzleReveal:
            "",
        };

      if (
        url == "Wallet/get-puzzle" &&
        args.body == '{"parentCoinId":"0x1718f1cc4aa62ace337f04208e62cbce178a3c0edec9f85638cf7c093129c450"}'
      )
        return {
          ...
          puzzleReveal:
            "",
        };

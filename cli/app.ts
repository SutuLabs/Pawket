...
import { OriginCoin, signSpendBundle, UnsignedSpendBundle } from "../lib-chia/services/spendbundle";
...
Instance.init().then(() => {
  ...
  app.post("/inscribe_mint", async (req: express.Request, res: express.Response) => {

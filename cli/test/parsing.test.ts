...
import bcase11 from "./cases/block_case11.json";
...
describe("Parsing API test", () => {
  ...
  test("Block Parsing Case 11", () => testCase("/parse_block", bcase11));
  ...
  )("Analyze Tx Case %s", (ca) => testCase("/analyze_tx", ca));
});
...
describe("Puzzle API test", () => {
  test("Puzzle To Address", async () => {
    const resp = await request(app)
      .post("/puzzle")
      .send({ method: "ToAddress", parameters: ["0xb93495c7c2f956454ee75f96c0e5ca51d0b8165aebe6e15e8a1f288512b97f6c"] });
    expect(resp.status).toBe(200);
